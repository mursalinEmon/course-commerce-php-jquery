...
if (!defined('PAYGATE_URL')) {
    define('PAYGATE_URL', 'http://localhost/abclit/');
}

if (!defined('API_DOMAIN_URL')) {

    define('API_DOMAIN_URL', 'http://sandbox.sslcommerz.com');
    // define('API_DOMAIN_URL', 'http://securepay.sslcommerz.com');
}
            ...
            foreach($xml->children() as $child)
            {
                if ($child->getname()=="conf"){
                    ...
                    if (!defined('HW_QUESTION_LOCATION'))   
                        define ('HW_QUESTION_LOCATION',''.(string)$child->hwquestionlocation.'');
