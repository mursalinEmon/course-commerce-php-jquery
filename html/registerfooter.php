			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-md-3 col-lg-3">
					<div class="footer_contact_widget">
						<h4>CONTACT</h4>
						<p>L.R Bhaban</p>
						<p>1/2 Outer Circular Rd, Dhaka</p>
						<p>+8801958536733</p>
				...
				<div class="col-sm-6 col-md-4 col-md-3 col-lg-2">
					<div class="footer_program_widget">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#">Speaking English</a></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-6 col-md-4 col-md-3 col-lg-2">
					...
					<div class="footer_apps_widget">
						...
						<div class="app_grid">
							...
							<button class="play_store_btn btn-dark">
							    <a href="https://l.facebook.com/l.php?u=https%3A%2F%2Fplay.google.com%2Fstore%2Fapps%2Fdetails%3Fid%3Dapps.hasnat_azam.abclit_neumorphism%26fbclid%3DIwAR1WQcYTikmKqcT23EI1X3xQd1inFUpMn7QHSnhxWSb-1YUoX-YsFS-4PiM&h=AT3QKlz806gliDY4Ej_tW1Xgdr9FHtAin6w2omBVI5Q-3KMl3EXSb9onsMOKTpHU2Zveepaez0_dqTA3j6uwXtzp5WrmwcqlB3U5q1n95C6ugaHczusFePWSii0-GhQ8CnD28w" target="_blank">
								<span class="icon">
									<span class="flaticon-google-play"></span>
								</span>
								<span class="title">Google Play</span>
								<span class="subtitle">Get in on</span></a>
							</button>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-4 col-md-3 col-lg-3 col-xl-2 pb15 pt15">
					<div class="logo-widget home2">
					    <a href="<?php echo URL?>">
						<img style="height: 50px;" class="img-fluid" src="<?php echo URL?>assets/images/ABCL logo.png" alt="header-logo.png">
						<!-- <span>ABCL IT</span> -->
						</a>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-6 offset-lg-3">
					<div class="copyright-widget text-center">
						<p>Copyright ABCL IT © 2021. All Rights Reserved.</p>
					</div>
				</div>
			</div>
		</div>
