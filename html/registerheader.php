...
<head>
    ...
    <!-- <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/bootstrap.min.css"> -->
    <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/line-awesome.css">
    <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/animate.min.css">
    <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/owl.theme.default.min.css">
    <!-- <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/bootstrap-select.min.css"> -->
    <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/fancybox.css">
    <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/tooltipster.bundle.css">
    <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/style.css">
    <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/toast.css">
    <!-- <link rel="stylesheet" href="<?php echo URL;?>assets/dot/css/responsive.css"> -->
						...
						<ul>
							<li class="list-inline-item">
								<div class="logo-widget">
								    <a href="<?php echo URL?>">
									<img class="img-fluid" src="<?php echo URL?>assets/images/ABCL logo.png" alt="header-logo.png" style="height:65px;">
									<!-- <span>ABCL IT</span> -->
									</a>
								</div>
							</li>
		...
		<div class="container">
		    ...
		    <nav>
		        ...
		        <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
		            <li class="last">
		                <a class="last" href="<?php echo URL;?>home"><span class="last">Home</span></a>
		                <!-- Level Two-->
		                <!-- <ul>
		        ...
		        <ul class="sign_up_btn pull-right dn-smd mt20" style="padding-bottom: 7px!important;">
				<li class="list-inline-item" style="padding-bottom: 7px!important;">
					<div id="chopcart" class="shop-cart" style="padding-bottom: 7px!important;">
									<ul>
										<li>
											<p style="padding-bottom: 7px!important;" class="shop-cart-btn d-flex align-items-center">
		...
		<div class="mobile-menu">
			<div class="header stylehome1">
				<div class="main_logo_home2">
		            <img class="nav_logo_img img-fluid float-left mt20" src="assets/images/ABCL logo.png" alt="header-logo.png" style="height:45px;">
		            <!-- <span>ABCL IT</span> -->
				</div>
