...
class Createquestion extends Controller{
	...
	private function intializeform(){
        ...
        $this->formfield = array(
			...
			"exammstsl"=>array("required"=>"*","label"=>"Class ID","ctrlfield"=>"xexammstsl", "ctrlvalue"=>"", "ctrltype"=>"text", "readonly"=>"readonly", "ctrlvalid"=>array(),"rowindex"=>"1"),
			...
			"questionset"=>array("required"=>"*","label"=>"Question Set","ctrlfield"=>"xset", "ctrlvalue"=>"", "ctrltype"=>"text", "ctrlvalid"=>array("required"=>"true","minlength"=>"1"),"rowindex"=>"3"),
        ...
        $this->formset = array(
            ...
            "mainbtn"=>array(
                ...
                array("btnmethod"=>"view","btntext"=>"View Question","btnurl"=>URL."questioncreate/singleQuestion","btnid"=>"viewnotice", "icon"=>"<i class=\"far fa-info mr-1\"></i>","btncolor"=>"btn-info"),
