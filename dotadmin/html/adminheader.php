...
<head>
    ...
    <title>eGen</title>
    <link rel="icon" type="image/x-icon" href="<?php echo URL; ?>public/images/biz/egen.png">
    <!-- Switcher CSS -->
                ...
                <div class="menu">
                    ...
                    <?php if (Session::get('slogintype') == "Admin"){ ?>
                        ...
                        <li class="has-sub" id="mnugroups">
                            <a><i class="far fa-sun"></i><span>Batch Settings</span><i class="arrow"></i></a>
                            <ul class="sub-menu">
                               <li id="subcreatebatch">

                                   <a href="<?php echo URL; ?>createbatch"><span>Create Batch</span></a>
                                  
                               </li>
                               <li id="subassignstudent">

                                   <a href="<?php echo URL; ?>assignstudent"><span>Assign Student</span></a>
                        ...
                        <li class="has-sub" id="mnunotice">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li id="substudymaterialview">
                                    <a href="<?php echo URL; ?>studymaterialview"><span>Exam Assign</span></a>
                                </li>
                                <li id="substudymaterialview">
                                    <a href="<?php echo URL; ?>studymaterialview"><span>Exam Evaluation</span></a>
                                </li>
                    ...
                    <div class="col-4 col-md-7 page-hdr-left">
                        ...
                        <div id="logo">
                            <div class="tbl-cell logo-icon">
                                <a href="/"><img src="<?php echo URL; ?>public/images/biz/egen.png" alt=""></a>
                            </div>
                            <div class="tbl-cell logo">
                                <a href="/"><img  src="<?php echo URL; ?>public/images/biz/egen.png"></a>
                            </div>
                        </div>
